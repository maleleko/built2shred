...
const BearingsBrands = () => {
  return (
    ...
    <div className='brands-headline'>
      <h2 className='culture-history font-mono text-xl'><b>featured skateboarding bearing companies</b></h2>
    <p className='hello font-mono text-xs'>the small circular devices placed inside the wheel </p>
  </div>
  ...
  <div className='brand m-0.5'>
      <div className='brandcontent -mt-20'>
        ...
        <div className='textcontent'>
          <p className='texttag font-mono text-sm mr-24'><b>bones bearings:</b> founded in 1983 by skateboarding legends George Powell and Stacy Peralta, you may have noticed these are the same founders of bones wheels. bones bearings is one of the most reputable and well-known bearing brands in the skateboarding industry, as well as being one of the most affordable options for bearings. known for their speed, durability and precision, bones bearings is a staple in the skateboarding industry. the company has been a respected brand in the skateboarding industry for over 30 years, collaborating with other skateboarding brands such as Vans, Trasher, and many others.</p>
        </div>
      </div>
    </div>
