...
const WheelBrands = () => {
  return (
    ...
    <div className='brands-headline'>
      <h2 className='culture-history font-mono text-xl'><b>featured skateboarding wheel companies</b></h2>
    <p className='hello font-mono text-xs'>the polyurethane wheels attached to your trucks</p>
  </div>
