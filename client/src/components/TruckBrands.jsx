  ...
  return (
    <div className='culture-content'>
        <div className='brands-headline'>
          <h2 className='culture-history font-mono text-xl text-stone-600'><b>featured skateboarding truck companies</b></h2>
        <p className='hello font-mono text-xs text-slate-600'>the 2x2 metal baseplate with axels screwed onto the board</p>
      </div>
      ...
      <div className='brand m-0.5'>
          <div className='brandcontent -mt-20'>
            ...
            <div className='textcontent'>
              <p className='texttag font-mono text-sm mr-24 text-stone-600'><b className='text-slate-600'>ace:</b> founded in 2012 by professional skaters Eric Koston and Guy Mariano. the company's trucks are known for their precision and durability, and are popular among professional skaters. ace trucks quickly gained a reputation for being a high-quality alternative to the more established truck brands in the industry. the company's marketing strategy has focused heavily on partnerships with professional skateboarders, which helped to establish ace trucks as a reputable brand in the industry. in addition to manufacturing traditional trucks, ace trucks also offers a line of "low" trucks, which are designed for skaters who prefer a lower riding style.</p>
            </div>
          </div>
        </div>
        ...
        <div className="brand">
          <div className='textcontent'>
            <p className='texttag font-mono text-sm mb-48'><b className='text-stone-600'> these are some of the most influential brands in skateboarding history, which is why they're featured on this application. more brands to be added in the future, so be on the lookout.</b> </p>
          </div>
          </div>
