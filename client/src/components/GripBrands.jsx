  ...
  return (
    <div className='culture-content'>
        <div className='brands-headline'>
          <h2 className='culture-history font-mono text-xl text-stone-600'><b>featured griptape companies</b></h2>
        <p className='hello font-mono text-xs text-slate-600'>the sheet of sandpaper applied on top of the board</p>
      </div>
