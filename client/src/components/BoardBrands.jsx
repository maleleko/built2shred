  ...
  return (
    <div className='culture-content'>
      <div className='brands-headline'>
        <h2 className='culture-history font-mono text-xl text-stone-600'><b>featured board companies</b></h2>
        <p className='hello font-mono text-xs text-slate-600'>the planks of wood under your feet</p>
      </div>
